...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $clinic = Clinic::query()->updateOrCreate([
            ...
            'logo_path' => 'branding/logos/logo-clinica.webp',
            'domain' => null,
        ...
        foreach ([
            ...
            ['group' => 'branding', 'key' => 'home_banner_1_image', 'value' => '', 'type' => 'image', 'label' => 'Imagen banner home 1'],
            ['group' => 'branding', 'key' => 'home_banner_2_image', 'value' => '', 'type' => 'image', 'label' => 'Imagen banner home 2'],
            ['group' => 'branding', 'key' => 'home_banner_3_image', 'value' => '', 'type' => 'image', 'label' => 'Imagen banner home 3'],
            ...
            ['group' => 'contact', 'key' => 'email', 'value' => 'Drkevinrejuvenezkoficial@gmail.com', 'type' => 'string', 'label' => 'Email'],
            ['group' => 'contact', 'key' => 'address', 'value' => 'Bogotá, Colombia', 'type' => 'string', 'label' => 'Dirección'],
            ['group' => 'social', 'key' => 'instagram_url', 'value' => 'https://www.instagram.com/drkevin_rejuvenezk/', 'type' => 'string', 'label' => 'Instagram'],
            ['group' => 'social', 'key' => 'facebook_url', 'value' => 'https://www.facebook.com/profile.php?id=61576918324850', 'type' => 'string', 'label' => 'Facebook'],
        ...
        $doctor->fill([
            ...
            'photo_path' => 'doctors/doctor-kevin-perfil.jpg',
